...
giddh.webApp.config ($stateProvider, $urlRouterProvider, $locationProvider) ->
  ...
  $stateProvider.state('/home',
    ...
    templateUrl: 'http://1.'+location.host+'/public/webapp/views/demo.html'
    controller: 'homeController'
  )
  .state('Reports',
    url: '/reports'
    templateUrl: 'http://1.'+location.host+'/public/webapp/Reports/reports.html',
    controller: 'reportsController',
    params: {'frmDt': null, 'toDt': null, 'type': null}
  )
  .state('audit-logs',
    url: '/audit-logs'
    templateUrl: 'http://1.'+location.host+'/public/webapp/AuditLogs/audit-logs.html',
    controller:'logsController'
  )
  .state('search',
    url: '/search'
    templateUrl: 'http://1.'+location.host+'/public/webapp/Search/searchContent.html'
    controller: 'searchController'
  )
  .state('invoice',
    url: ''
    abstract: true
    templateUrl: 'http://1.'+location.host+'/public/webapp/views/home.html'
  ...
  .state('invoice.accounts',
    ...
    views:{
      'accounts':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/Invoice/invoiceAccounts.html'
      }
      'rightPanel':{
        abstract:true
#        templateUrl: '/public/webapp/Invoice/invoiceContent.html'
  ...
  .state('invoice.accounts.invoiceId',
    url: '/:invId'
    templateUrl: 'http://1.'+location.host+'/public/webapp/Invoice/invoiceContent.html'
  )
  .state('company'
    url: ''
    abstract: true
  ...
  .state('company.content.manage',
    ...
    views:{
      'accountsList':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/views/accounts.html'
        #template: "<div>manage page</div>"
      }
      'rightPanel':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/ManageCompany/manageCompany.html'
      }
    }
  )
  .state('company.content.user',
    ...
    views:{
      ...
      'rightPanel':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/UserDetails/userDetails.html'
        controller: 'userController'
      }
    }
  )
  .state('company.content.tbpl',
    ...
    views:{
      ...
      'rightPanel':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/Tbpl/tbpl.html'
  ...
  .state('company.content.ledgerContent',
    ...
    views:{
      ...
      'rightPanel':{
        templateUrl: 'http://1.'+location.host+'/public/webapp/Ledger/ledger.html'
  ...
  .state('dashboard',
    url: '/dashboard'
    templateUrl: 'http://1.'+location.host+'/public/webapp/Dashboard/dashboard.html'
  )
  .state('/thankyou',
    url: '/thankyou'
    templateUrl: 'http://1.'+location.host+'/public/webapp/views/thanks.html'
...
#    $rootScope.callFromHere = "http://1."+location.host
